 ...
 * @Description:
 * @author: 贾森
 * @date: 2022年02月08日 下午5:36
 */
@Tags({"monitor", "监控", "数据质量检测"})
@CapabilityDescription("监控数据-数据回写")
public class ZtgxQmRewriteProcessor extends AbstractProcessor {
...
//                        }
            ...
            List<DirtyData> dirtyDataList1 = multiThread.getResult();
            List<DirtyData> dirtyDataList = new ArrayList<>();
            for(DirtyData dirtyData : dirtyDataList1){
                if (dirtyData.getErrorDataList().size()>0){
                    dirtyDataList.add(dirtyData);
                }else{
                    rightData.add(dirtyData.getJsonObject());
                }
            }
            getLogger().info(".............................................rightData:" + rightData.size());
            getLogger().info(".............................................rightData:" + rightData.toJSONString());
            getLogger().info(".............................................dirtyDataList:" + dirtyDataList.size());
            getLogger().info(".............................................dirtyDataList:" + dirtyDataList.toString());
